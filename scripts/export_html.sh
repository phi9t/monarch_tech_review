...
<body>
  ...
  <ul class="notebooks">
    ...
    <li>
      <a href="04_distributed_tensors.html">
        <span class="nb-num">04</span> Distributed Tensors in Monarch
        <span class="nb-desc">Mesh activation, broadcasting tensor compute, collectives, remote GPUs, and device mesh dimensions.</span>
      </a>
    </li>
  </ul>
  ...
  <ul class="notebooks">
    <li>
      <a href="05_rl_intro.html">
        <span class="nb-num">05</span> RL at Scale: The Systems Problem
        <span class="nb-desc">Why RL training is a distributed systems problem. Sync vs async, on-policy vs off-policy.</span>
      </a>
    </li>
    <li>
      <a href="06_services.html">
        <span class="nb-num">06</span> Services: Managing Worker Pools
        <span class="nb-desc">Round-robin routing, health tracking, failure recovery, and service discovery.</span>
      </a>
    </li>
    <li>
      <a href="07_rdma_weight_sync.html">
        <span class="nb-num">07</span> RDMA &amp; Weight Synchronization
    ...
    <li>
      <a href="08_rl_e2e.html">
        <span class="nb-num">08</span> Closing the Loop: Async RL Training
